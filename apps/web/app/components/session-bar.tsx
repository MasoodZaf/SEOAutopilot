  ...
  return (
    <div className="flex items-center gap-3 text-[13px]">
      ...
      <form action="/auth/logout" method="post">
        <button type="submit" className={button.secondary}data-tip="End this session on this browser. Your workspace, keys and sites are untouched." data-tip-side="bottom" aria-describedby="tip-aa7d586602">
          Sign out
        </button>
      </form>
    </div>
